      ...
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div id="mobile-nav" className="flex md:order-2">
            <button
              type="button"
              data-tooltip-target="navbarr-search-example-toggle-darkmode-tooltip"
          ...
          <div
            id="nav-links"
            className={`${hidden ? "hidden" : "empty"} items-center justify-between w-full md:flex md:w-auto md:order-1`}
          >
